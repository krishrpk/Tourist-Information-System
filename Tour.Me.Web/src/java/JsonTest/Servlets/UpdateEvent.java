...
public class UpdateEvent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Event evnt=gson.fromJson(sb.toString(),Event.class);
            java.sql.Connection con = new DBConn().getConnection();
            String getquery="UPDATE event set date='"+evnt.getDate()+"',time='"+evnt.getTime()+"',description='"+evnt.getDescription()+"' WHERE eventid="+evnt.getEventid();
