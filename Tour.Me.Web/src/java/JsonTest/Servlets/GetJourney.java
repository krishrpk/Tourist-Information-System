 ...
 * @author Heshitha
 */
@WebServlet(name = "GetJourney", urlPatterns = {"/GetJourney"})
public class GetJourney extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String getquery = "SELECT * from journey WHERE journeyid="+journeytxt.getJourneyid()+"";
            ...
            while (res.next()) {
                   ...
                   journey.setStartlat(res.getString("startlat"));
                   journey.setStartlng(res.getString("startlng"));
                   journey.setEndlat(res.getString("endlat"));
                   journey.setEndlng(res.getString("endlng"));
                   journey.setEvents(getEvents(con,res.getString("journeyid")));
                   
                }
                String JsonString = gson.toJson(journey, Journey.class);
