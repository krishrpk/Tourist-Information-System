 ...
 * @author Heshitha
 */
@WebServlet(name = "BrowsePOI", urlPatterns = {"/BrowsePOI"})
public class BrowsePOI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BrowsePOI.class.getName()).log(Level.SEVERE, null, ex);
        } finally {            
            out.close();
        }
    }
